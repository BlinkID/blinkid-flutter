...
void main() {
  runApp(MaterialApp(locale: Locale('ar'), home: MyApp()));
}
...
class _MyAppState extends State<MyApp> {
  ...
  String getIdResultString(dynamic result) {
    ...
    if (result is BlinkIdMultiSideRecognizerResult ||
        result is BlinkIdSingleSideRecognizerResult) {
      recognizerResult =
  ...
  String buildAdditionalProcessingInfoResult(
    AdditionalProcessingInfo? result,
    String propertyName,
  ) {
    if (result == null) {
      return "empty";
  ...
  String buildDataMatchResult(DataMatchResult? result) {
    ...
    return buildStringResult(result.dateOfBirth.toString(), "Date of birth") +
        ...
        buildStringResult(
          result.stateForWholeDocument.toString(),
  ...
  Widget build(BuildContext context) {
    if (Theme.of(context).platform == TargetPlatform.iOS) {
      license =
          "";
