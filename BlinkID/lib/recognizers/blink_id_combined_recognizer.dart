...
class BlinkIdCombinedRecognizerResult extends RecognizerResult {
  ...
  BlinkIdCombinedRecognizerResult(Map<String, dynamic> nativeResult)
    ...
    this.backImageAnalysisResult = nativeResult["backImageAnalysisResult"] !=
            null
        ? ImageAnalysisResult(
            Map<String, dynamic>.from(nativeResult["backImageAnalysisResult"]))
        : null;
    ...
    this.frontImageAnalysisResult = nativeResult["frontImageAnalysisResult"] !=
            null
        ? ImageAnalysisResult(
            Map<String, dynamic>.from(nativeResult["frontImageAnalysisResult"]))
        : null;
...
class BlinkIdCombinedRecognizer extends Recognizer {
  ...
  factory BlinkIdCombinedRecognizer.fromJson(Map<String, dynamic> json) =>
      _$BlinkIdCombinedRecognizerFromJson(json);
