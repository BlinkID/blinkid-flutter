...
class DocumentFaceRecognizerResult extends RecognizerResult {
  ...
  DocumentFaceRecognizerResult(Map<String, dynamic> nativeResult)
    ...
    this.documentLocation = nativeResult["documentLocation"] != null
        ? Quadrilateral(
            Map<String, dynamic>.from(nativeResult["documentLocation"]))
        : null;
...
class DocumentFaceRecognizer extends Recognizer {
  ...
  factory DocumentFaceRecognizer.fromJson(Map<String, dynamic> json) =>
      _$DocumentFaceRecognizerFromJson(json);
